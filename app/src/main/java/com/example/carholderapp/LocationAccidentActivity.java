...
public class LocationAccidentActivity extends FragmentActivity implements GoogleMap.OnMapLongClickListener, GoogleMap.OnMarkerDragListener,OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.report_location_layout);
        ...
        buttonGo = findViewById(R.id.go_detction);
        buttonGo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                LatLng markedlocatoin = new LatLng(latitude,longitude);
                GlobleVariableClass.CurrentLocation = markedlocatoin;
                GlobleVariableClass.givenAddress = address.getText().toString();
                Intent intent = new Intent(LocationAccidentActivity.this, ImageclasificationActiviy.class);
    ...
    private void configureCameraIdle() {
        onCameraIdleListener = new GoogleMap.OnCameraIdleListener() {
            ...
            public void onCameraIdle() {
                ...
                Geocoder geocoder = new Geocoder(LocationAccidentActivity.this);
    ...
    public void onLocationChanged(Location location) {
        ...
        Toast.makeText(LocationAccidentActivity.this,"Your Current Location", Toast.LENGTH_LONG).show();
